...
This module defines the configuration class for the `oc_lettings_site` project.
It specifies metadata and settings used by Django to initialize the project.
